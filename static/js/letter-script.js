...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Function for Particle
        ...
        var shakerWidth = $('.shaker');
        var screenWidth = shakerWidth.innerWidth();
        var screenHeight = shakerWidth.innerHeight();
        var halfWidth = shakerWidth.innerWidth() / 2;
        var halfHeight = shakerWidth.innerHeight() / 2;

        function updateCanvasAndScreenVars() {

          screenWidth = shakerWidth.innerWidth();
          screenHeight = shakerWidth.innerHeight();
          halfWidth = shakerWidth.innerWidth() / 2;
          halfHeight = shakerWidth.innerHeight() / 2;
...
//        console.clear();
        ...
        $("#stamp-envelope").on("click", function(e) {
          ...
          explode(dialog, e.clientX, e.clientY);
          $(".dialog").hide();
          $(".message").fadeIn(3000);
